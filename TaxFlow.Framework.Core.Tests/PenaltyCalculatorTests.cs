...
public class PenaltyCalculatorTests
{
    ...
    public void Calculate_Assiette_Fixed_And_Periodic_Rate_Lines()
    {
        ...
        List<PenaltyAccrual> rateLines = result.Accruals.Where(a => a.LineType == PenaltyLineType.AssietteRate).ToList();
    ...
    public void Calculate_Recouvrement_Periodic_Lines_On_Unpaid()
    {
        ...
        PaymentSchedule schedule = new PaymentSchedule(declarationId, null, new[] { installment });
        ...
        List<PenaltyAccrual> recLines = result.Accruals.Where(a => a.LineType == PenaltyLineType.RecouvrementRate).ToList();
